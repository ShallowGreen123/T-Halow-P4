...
auto Tx_Ah_R900pnr_Sdio_Bus = std::make_shared<Cpp_Bus_Driver::Hardware_Sdio>(
    TX_AH_R900PNR_CLK, TX_AH_R900PNR_CMD, TX_AH_R900PNR_D0,
    TX_AH_R900PNR_D1, TX_AH_R900PNR_D2, TX_AH_R900PNR_D3
);
